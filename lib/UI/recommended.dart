          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                if (index + 1 < RecommendedImages.length) {
                  return Row(
                    children: [
                      Expanded(
                        child: RecommenedList(
...
Widget RecommenedList(String imagePath, String productName, String productPrice,
